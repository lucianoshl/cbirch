...
git pull
set +e
mvn clean install -DskipTests exec:exec -Dexec.args="-classpath %classpath -Xmx6656m -javaagent:/home/void/birch-experiment/SizeOf.jar br.edu.ufu.comp.pos.db.imageretrieval.framework.Launcher birch oxford 100 2000 3072"
set -e
