...
public class CFNode {
     ...
     * @param newE2
     */
    protected void redistributeEntries(
        ArrayList< CFEntry > oldEntries,
        CFEntryPair farEntries,
        CFEntry newE1,
        CFEntry newE2 ) {
     ...
     */
    protected void redistributeEntries(
        ArrayList< CFEntry > oldEntries1,
        ArrayList< CFEntry > oldEntries2,
        CFEntryPair closeEntries,
        CFEntry newE1,
        CFEntry newE2 ) {
