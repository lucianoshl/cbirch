...
public class ResultReport {
    ...
    public void writeJson( JsonWriter jwriter )
        throws IOException {
    ...
    private void putItem( JsonWriter jwriter, Gson gson, String name, Object obj )
        throws IOException {
    ...
    private File createHtmlFile( String resultFolderPath, String fileName, File outJsonFile )
        throws IOException {
