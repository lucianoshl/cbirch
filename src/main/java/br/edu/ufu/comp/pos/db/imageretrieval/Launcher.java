...
public class Launcher {
	...
	public static void main(String[] args) throws IOException {
		...
		CFTree tree = new CFTree(100, 0.01, 1, true);
		tree.setAutomaticRebuild(true);
		tree.setMemoryLimit(1024l * 1024l * 4l);
		...
		List<Image> allImages = dataset.list();
//		Collections.shuffle(allImages);
		for (Image queryImage : allImages) {
		...
		String baseTemplate = IOUtils.toString(Launcher.class.getClassLoader().getResource("templates/results.html"));
