...
public class CFEntry implements TreeNode {
    ...
    protected boolean isWithinThreshold(CFEntry e, double threshold, DistanceMeasure distFunction) {
     ...
     */
    protected double distance(CFEntry e, DistanceMeasure distFunction) {
        return distFunction.compute(e.sumX,sumX);
    }
    ...
    public String toString() {
        return Arrays.toString(this.getCenter());
    }
